...
* Une image `Docker` qui fournit un environnement complet et reproductible pour produire la documentation ;
* Des tests automatique qui vérifient que les contributions ne comportent pas d'erreur de programmation, et que les exemples sont bien reproductibles (intégration continue) ;
...
+ facilite le travail des coordinateurs et des contributeurs ;
+ assure un environnement plus reproductible ;
+ permet de se concentrer sur le fond ;
+ n'oblige pas à connaître tous les détails de la production de la documentation (on peut ne pas connaître `R` et contribuer).
