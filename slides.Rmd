...
description_appariement <- 
  as.data.table(
    data.frame(
      ...
      filtres_validation = 
        c(
          "10000 : nom de conjoint très similaire et prénoms identiques dans le même ordre",
          "5000 : nom de conjoint très similaire",
          "10000 : nom de conjoint très similaire et prénoms identiques dans le même ordre",
          "5000 : nom de conjoint très similaire",
          "10000 : nom de conjoint très similaire et prénoms identiques dans le même ordre",
          "5000 : nom de conjoint très similaire",
...
kbl(description_appariement, align = "cll",
    col.names = c("Etape", 
                  "Critères de validation et calcul du score")
) %>%
...
1. Travailler avec `R` à l'Insee :
    ...
    + Comment utiliser `git` et Gitlab avec RStudio...
...
- Elles comportent des conseils et des remarques relatifs vers bonnes pratiques ;
