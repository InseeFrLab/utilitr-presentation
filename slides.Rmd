...
Chaque fiche :
--
+ commence par quelques **recommandations** sur les outils et les _packages_ à utiliser ou à éviter ;

<!-- IL FAUDRAIT METTRE UNE BOITE RECOMMANDATION ICI -->

--
+ présente en détail les outils les plus adaptés pour réaliser la tâche considérée ;

--
+ contient des conseils et des remarques sur les bonnes pratiques à adopter ;

<!-- IL FAUDRAIT METTRE DEUX BOITES CONSEIL ET REMARQUE ICI -->

--

+ comporte des **exemples de code reproductibles et proches des cas d'usage**. 
