...
output :
  xaringan::moon_reader:
    ...
    - custom.css
    - css/metropolis.css
    # Cet argument fait planter la compilation
    # extra_dependencies:
...
- Cette documentation est issue de la mise en commun des connaissances des agents du SSP sur `R` dans une approche _bottom-up_, sur le modèle de Wikipedia. 
...
+ Chaque fiche commence par quelques **recommandations** sur les outils et les _packages_ à utiliser ou à éviter ;

<!-- IL FAUDRAIT METTRE UNE BOITE RECOMMANDATION ICI -->

--

+ Chaque fiche présente en détail les outils les plus adaptés pour réaliser la tâche considérée ;

-- 
+ Chaque fiche contient des conseils et des remarques sur les bonnes pratiques à adopter ;

<!-- IL FAUDRAIT METTRE DEUX BOITES CONSEIL ET REMARQUE ICI -->
...
* Organisation sans hiérarchie :
    ...
    * Un _comité de parrainage_ composés de managers : Benoît Rouppert, Arnaud Degorre, Patrick Sillard, Sébastien Roux.
--
