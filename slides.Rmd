...
* Les codes sources de la documentation prennent la forme de fichiers `R Markdown` ;
* `R` compile ces codes sources de deux manières :
    + Production d'un site internet grâce au _package_ `blogdown` (`.Rmd` -> `.md` -> `.html`) ;
    + Production d'un livre en format A4 grâce au _package_ `pagedown` (`.md` -> `.html` -> `.pdf`) ;
    + L'utilisation de `paged.js` permet de transformer chaque page du site internet en un chapitre paginé propre à être imprimé.
