...
- La version intégrale de la documentation vous serait-t-elle utile, sachant que chaque fiche est déjà disponible en format A4 imprimable ?
- Une version __imprimée et millésimée__ de la brochure (350 pages) vous serait-elle utile ?
...
* Des scripts automatiques qui vérifient que les contributions ne comportent pas d'erreur de programmation, et que les exemples sont bien reproductibles (intégration continue) ;
