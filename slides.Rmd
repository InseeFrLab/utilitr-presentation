...
---
# Introduction
## Les apports du projet `utilitR` (1)

- Sur le plan de l'organisation :
    - entièrement _open source_ ;
    - Démarche collaborative à grande échelle et au niveau du SSP entier ;
    - Outils collaboratifs (Git/Github) ;

---
# Introduction
## Les apports du projet `utilitR` (2)

- Sur le plan technique :
    - Entièrement reproductible et sur données réelles ;
    - Chaîne de production intégrée avec `R` : plusieurs _outputs_ avec les mêmes codes sources ;
    - Infrastructure technique à l'état de l'art :
    - permet des évolutions de l'écosystème `R Markdown` bénéficiant à des milliers d'utilisateurs
    
__Le projet `utilitR` est un laboratoire de nouvelles méthodes de travail pour les statisticiens.__
