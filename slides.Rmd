...
- Les jeux d'exemple sont **disponibles dans tous les environnements de travail**. Ils sont mis à disposition dans le _package_ `doremifasolData` développé par Pierre Lamarche et Pierre-Yves Berrard.
