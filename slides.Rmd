...
description_appariement <- 
  as.data.table(
    data.frame(
      etape = c(
        rep('Utiliser `R` à l’Insee', 3),
        rep("Mener un projet statistique avec `R`", 6),
        rep("Importer des données", 2),
        rep("Manipuler des données", 2),
        rep("Produire des _outputs_", 2)),
      filtres_validation = 
        c(
          "Les environnements de travail avec `R` à l'Insee : AUSv3 et SSPCloud", "Gérer les ressources informatiques avec `R`", "Personnaliser la configuration de `R`",
