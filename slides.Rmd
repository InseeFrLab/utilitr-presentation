...
Chaque fiche d'`utilitR` a deux particularités :
...
+ **Des exemples de code reproductibles et proches des cas d'usage**. Les agents peuvent reproduire presque tous les exemples de la documentation sur leur poste (ou dans AUSv3 ou sur le SSP) en recopiant le code des exemples :
