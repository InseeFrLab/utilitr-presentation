...
écosystème ;
    2. Comment réaliser efficacement des tâches élémentaires avec `R`.

--

La documentation ne prétend pas être exhaustive ou sans erreurs. **Elle est issuede la mise en commun des connaissances sur `R` que les agents de la statistique publique ont accumulées dans le cadre de leurs activités.**
...
* Un portail d'accès sous forme de site *web* :
    ...
    + Guide des bonnes pratiques en `R` [www.pratiques.utilitr.org](www.pratiques.utilitr.org).

S'il ne faut retenir qu'un lien [www.utilitr.org](wwww.utilitr.org).
