...
.sauterligne3[
`utilitR` projets aims to propose a collaborative documentation
...
- `utilitR` is a practical guide that aims answer the following questions  :  
...
- There are still some missing parts in `utilitR` :
    + How to make nice maps with `R` `r fontawesome::fa("fa-r-project")` ?
    + `Shiny` <br>
