...
- Pourquoi mettre en place l'intégration continue ?
...
* Les contributeurs collaborent à travers le dépôt `Github`
...
* Arrière plan: scripts automatiques pour créer l'environnement de reproductibilité de la documentation
...
* Documentation automatiquement déployée en plusieurs formats
* Mais besoin de tester des évolutions...
...
* Un site temporaire est associé à chaque contribution
...
* Un bouton *Edit this page* `r fontawesome::fa("fab fa-github")` sur [www.book.utilitr.org](https://www.book.utilitr.org) pour utiliser l'interface visuelle `Github` :
    + éditer la dernière version de la fiche (la source de vérité) ;
    + proposer le changement (*pull request* automatiquement créée).
...
* _Issues_ : espace de débats et d'échanges:
    + signaler un *bug*, proposer une nouvelle fiche, un nouvel exemple, participer à un débat sur un *package*...


--

* Des *pull request* pour ajouter des éléments plus substantiels (nouvelles 
...
[InseeFrLab/utilitR](https://github.com/InseeFrLab/utilitR) sont les coordinateurs (Olivier Meslin et Lino Galiana)
...
+ elle assure un **environnement plus reproductible**
+ elle **facilite le repérage des erreurs** ;
...
---
# 4. Intégration continue: avantages
...
* **Pas de mail** pour s'échanger des fichiers ou des informations ;
    + Informations importantes archivées directement dans le projet, pas dans une boîte mail
