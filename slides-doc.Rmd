...
- un guide pratique pour le statisticien, pas une introduction théorique à `R` ;
...
* Démarche collaborative impliquant __25 contributeurs__ :
...
```{r, echo = FALSE, out.width= "40%", out.extra= 'style = "position: absolute; left: 0.5cm; top: 4cm;"'}
knitr::include_graphics("./resources/create_project_1.png")
```
```{r, echo = FALSE, out.width= "55%", out.extra= 'style = "position: absolute; left: 10.5cm; top: 4cm;"'}
knitr::include_graphics("./resources/create_project_0.png")
```
```{r, echo = FALSE, out.width= "40%", out.extra= 'style = "position: absolute; top: 12cm; left: 0.5cm;"'}
knitr::include_graphics("./resources/onglet_git1.png")
```
```{r, echo = FALSE, out.width= "50%", out.extra= 'style = "position: absolute; top: 12cm; left: 11cm;"'}
knitr::include_graphics("./resources/onglet_git8.png")
```

---
# Comment (bien) travailler avec `R` à l'Insee
## Et quand on veut utiliser `R` ailleurs qu'à l'Insee?
...
---
# Réaliser des tâches élémentaires avec `R`

.sauterligne3[
La seconde partie de la documentation présente .
]
