...
```{r}
filosofi_epci_2016_dt[(get("MED16") < 20000) & (get('NBMENFISC16') < 10000)]
```
...
```{r}
dt <- data.table::as.data.table(doremifasolData::filosofi_com_2016)
dt[,`:=`("dep" = substr(get('CODGEO'), 0, 2),
...
head(new_variable_group(dt, xvar = "TP6016",
                        newname = "newvar"))
```
...
head(na.omit(new_variable_group(dt, xvars = c("TP6016", "TP60AGE116"),
