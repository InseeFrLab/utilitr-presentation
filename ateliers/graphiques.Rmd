...
```{r, echo = FALSE, out.width= "50%", out.extra= 'style = "position: absolute; top: 5cm; left: 2cm; padding: 0;"', purl = FALSE}
knitr::include_graphics("../resources/intro_graphiques/addin_rstudio.png")
```

```{r, echo = FALSE, out.width= "25%", out.extra= 'style = "position: absolute; top: 5cm; left: 15cm; padding: 0;"', purl = FALSE}
