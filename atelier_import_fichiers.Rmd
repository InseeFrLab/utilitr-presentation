...
- fichiers **xlsx** <br/> → fonction `read.xlsx` du _package_ `{openxlsx}`
- fichiers **xls** <br/> → fonction `read_excel` du _package_ `{readxl}` \*
- fichiers **ods** <br/> → fonction `read_ods` du _package_ `{readODS}`
