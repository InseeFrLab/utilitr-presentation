...
- Tous les codes du projet sont stockés sur un dépôt Github ([https://github.com/InseeFrLab/utilitR](lien)) et disponibles sous licence libre (Licence Ouverte 2.0) ;
...
* `R` compile ces codes sources de deux manières :
    ...
    + Production d'une brochure pdf en format A4 grâce au _package_ `pagedown` ;
...
<br>
* Avantages :
    + Le site web et la brochure sont générés à partir des mêmes codes sources ;
